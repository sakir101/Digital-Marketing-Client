  ...
  return (
    <div className="w-full lg:w-96 h-96 mt-10">
      <button
        ...
        className="w-full flex justify-between items-center p-4 text-left cursor-pointer text-sm font-bold transition-all duration-300 border-t-[1px] border-x-0 border-b-0 bg-transparent border-solid border-black dark:border-white dark:text-white"
      >
      ...
      >
        <div className="p-4">
          <p className="text-gray-600 dark:text-white mb-10 text-xs">
